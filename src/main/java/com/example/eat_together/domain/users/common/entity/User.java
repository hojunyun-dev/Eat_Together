package com.example.eat_together.domain.users.common.entity;
...
public class User extends BaseTimeEntity {
    ...
    @Enumerated(EnumType.STRING)
    @Column(name = "social_login_type",nullable = true)
    ...
    @Builder(builderMethodName = "socialLogin")
    public User(String email, String nickname, String name, SocialLoginType socialLoginType) {
        this.email = email;
    ...
    // 소셜 로그인 사용자의 프로필 업데이트를 위한 별도 메서드
    public void updateSocialProfile(String name, String nickname) {
        if (name != null) {
            this.name = name;
        }
        if (nickname != null) {
